...
# 高级更新模式（支持7种模式）
feishu-docs doc update-v2 --doc-id <document_id> --mode append --markdown "追加内容"
feishu-docs doc update-v2 --doc-id <document_id> --mode overwrite --markdown "覆盖全部" --new-title "新标题"
feishu-docs doc update-v2 --doc-id <document_id> --mode replace_range --markdown "替换内容" --selection-with-ellipsis "开头...结尾"
feishu-docs doc update-v2 --doc-id <document_id> --mode replace_all --markdown "替换内容" --selection-by-title "## 章节标题"
feishu-docs doc update-v2 --doc-id <document_id> --mode insert_before --markdown "插入内容" --selection-by-title "## 目标标题"
feishu-docs doc update-v2 --doc-id <document_id> --mode insert_after --markdown "插入内容" --selection-with-ellipsis "定位文本..."
feishu-docs doc update-v2 --doc-id <document_id> --mode delete_range --selection-with-ellipsis "开始...结束"
...
feishu-docs wiki resolve --url "wiki/ABC123"
